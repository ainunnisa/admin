...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="col-md-12">
        <h4 style="text-align:center; margin-bottom:30px">Tugas</h4>
        <table id="tugas" class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead>
            <th>No</th>
            <th style="width:80%;">Tugas</th>
            <th>Aksi</th>
          </thead>
          <tbody>
            <?php 
            ...
            <tr>
              ...
              <td style="text-align: center;">
                <a href="<?php echo base_url() ?>index.php/C_TugasFungsi/edit_dataTugas/<?php echo $tugas->id; ?>" onClick="return confirm('Lakukan edit pada data ini?')">
                            <button class="btn btn-sm btn-primary">
                            <i class="glyphicon glyphicon-pencil"></i>
                            </button>
                          </a>
                <a href="<?php echo base_url() ?>index.php/C_TugasFungsi/hapusTugas/<?php echo $tugas->id; ?>" onClick="return confirm('Yakin akan menghapus data ini?')">
        ...
        <button class="btn btn-md btn-primary">
          <a href="<?php echo base_url() ?>index.php/C_TugasFungsi/inputTugas">
      ...
      <div class="col-md-12">
        <h4 style="text-align:center; margin-bottom:30px">Fungsi</h4>
        <table id="fungsi" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td><?php echo $fungsi->id; ?></td>   
              <td><?php echo $fungsi->fungsi; ?></td>
              <td>
                <a href="<?php echo base_url() ?>index.php/C_TugasFungsi/edit_dataFungsi/<?php echo $fungsi->id; ?>" onClick="return confirm('Lakukan edit pada data ini?')">
                            <button class="btn btn-sm btn-primary">
                            <i class="glyphicon glyphicon-pencil"></i>
                            </button>
                          </a>
                <a href="<?php echo base_url() ?>index.php/C_TugasFungsi/hapusFungsi/<?php echo $fungsi->id; ?>" onClick="return confirm('Yakin akan menghapus data ini?')">
                            <button class="btn btn-sm btn-danger">
                            <i class="glyphicon glyphicon-trash"></i>
                            </button>
                          </a>
        ...
        <button class="btn btn-md btn-primary">
          <a href="<?php echo base_url() ?>index.php/C_TugasFungsi/inputFungsi">
            <font style="color:white;">
              Tambah Fungsi
            </font>
          </a>
