...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <form method="post" action="<?php echo base_url()."index.php/C_VisiMisi/save_edit"; ?>">
        <input type="hidden" name="id" value="<?php echo $data->id; ?>">
          <table id="visimisi" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
              <th >Visi</th>
            </thead>
            <tbody>
              <tr>
                <td><textarea rows="2" cols="120" name="visi"><?php echo $data->Visi; ?></textarea></td>                                      
              </tr>
            </tbody>
          </table>
          ...
          <table id="visimisi" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
              <tr>
                <td><textarea rows="5" cols="120" name="misi"><?php echo $data->Misi; ?></textarea></td>
              </tr>
              <tr>
