...
<!--       <div class="row">
       <?php
        ...
        ?>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="kotak">
            <a href="#"></a>
            <a href="#"><img class="img-thumbnail" src="<?php echo base_url() . 'assets/images/'.$s->gambar  ?>"/></a>
              <div class="card-body">
                <h1 class="card-title">
                  <a href="#"><?php echo $s->nama ?></a>
                </h1>
             </div>
     ...
     <div class="col-md-12">
        <h4 style="text-align:center; margin-bottom:30px">Struktur Organisasi</h4>
        <table id="fungsi" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><img class="img-thumbnail" src="<?php echo base_url() . 'assets/images/'.$s->gambar  ?>"/ style="width:150px; height:150px;"></td>
              <td>
                <a href="<?php echo base_url() ?>index.php/C_Struktur/ubah/<?php echo $s->id; ?>" onClick="return confirm('Lakukan edit pada data ini?')">
                            <button class="btn btn-sm btn-primary">
                            <i class="glyphicon glyphicon-pencil"></i>
                            </button>
                          </a>
                <a href="<?php echo base_url() ?>index.php/C_Struktur/hapus/<?php echo $s->id; ?>" onClick="return confirm('Yakin akan menghapus data ini?')">
        ...
        <button class="btn btn-md btn-primary">
          <a href="<?php echo base_url() ?>index.php/C_Struktur/input">
