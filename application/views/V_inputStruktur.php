...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <?=$this->session->flashdata('pesan')?>
         <h3 align="center"><b>MASUKAN DATA BARU</b></h3>
           <div class="col-md-3">
           </div>
           <div class="jumbotron col-md-6">
             <?=form_open_multipart('C_Struktur/proses_input')?>
              ...
              <div class="form-group">
                ...
                <input type="text" name="jabatan" class="form-control" placeholder="Masukan Jabatan" id="jabatan" required>
              </div>
              <div class="form-group">
