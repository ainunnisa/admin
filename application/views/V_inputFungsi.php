...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <form action="<?php echo base_url() ?>index.php/C_TugasFungsi/input_aksiFungsi" method="POST">
      <div class="form-group">
        <label for="id">No</label>
        <input type="text" class="form-control" id="id" name="id" placeholder="No">
      </div>
      <div class="form-group">
        <label for="fungsi">Fungsi</label>
        <input type="text" class="form-control" id="fungsi" name="fungsi" placeholder="Ketikkan fungsi">
      </div>
