        ...
        <table id="visimisi" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <table id="visimisi" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              ?>
              <tr>
                <td><?php echo $vm->Misi; ?></td>                                       
              </tr>
              <?php } ?>
            </tbody>
          </table>
          <br>
          <a href="<?php echo base_url() ?>index.php/C_VisiMisi/edit_data/<?php echo $vm->id; ?>" onClick="return confirm('Lakukan update Visi Misi?')">
