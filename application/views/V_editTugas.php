...
<div class="wrapper">
  ...
  <div class="content-wrapper">
       ...
       <?php foreach ($edit_dataTugas as $data) { ?>
        <form method="post" action="<?php echo base_url()."index.php/C_TugasFungsi/save_editTugas"; ?>">
        <input type="hidden" name="id" value="<?php echo $data->id; ?>">
          ...
          <table id="tugas" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
              <tr>
                <td><textarea rows="5" cols="120" name="tugas"><?php echo $data->tugas; ?></textarea></td>
              </tr>
              <tr>
