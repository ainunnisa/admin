...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <form action="<?php echo base_url() ?>index.php/C_TugasFungsi/input_aksiTugas" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="tugas" name="tugas" placeholder="Ketikkan fungsi">
      </div>
